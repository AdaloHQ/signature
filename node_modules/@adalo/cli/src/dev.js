...
module.exports = async (args, opts) => {
  ...
  try {
    ...
    authToken = JSON.parse(fs.readFileSync(rc)).authToken
  } catch (err) {
    //console.log(err)
  ...
  const config = { ...(pkg.adalo || pkg.proton), name, version }
  console.log(config)
...
const getWebpackConfig = (libraryPath, inputPath, outputPath) => {
